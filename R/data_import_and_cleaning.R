...
# data_in <- haven::read_stata("T:/projects/HEED/Data/USoc prepared data/Test_Harry14.dta")
# 
...
pop_data <- expanded_data |> 
  select(pidp, wave, age_dv, sex_dv, gor_dv, mastat_dv, home_owner, dnc, hiqual_dv, wnw_race) |> 
