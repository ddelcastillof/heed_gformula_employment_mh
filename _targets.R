...
#    resources = resources_mice),
  ...
  tar_target(mi_results_four_waves_mcs_marginal,
    run_gformula(wide_mids = main_mice_mcs,
                 ...
                 intervention_pattern = main_wide_mcs$intervention,
                 M = gform_M,
  ...
  tar_target(mi_results_three_waves_mcs_marginal,
    run_gformula(wide_mids = sensitivity_1_mice_mcs,
                 wide_data_mi = sensitivity_1_mcs$data,
                  intervention_pattern = sensitivity_1_mcs$intervention,
                 M = gform_M,
                 estimand = "factor(regime) + 0"),
    deployment = "worker",
    resources = resources_gform),
  tar_target(mi_results_five_waves_mcs_marginal,
    run_gformula(wide_mids = sensitivity_2_mice_mcs,
                 wide_data_mi = sensitivity_2_mcs$data,
                  intervention_pattern = sensitivity_2_mcs$intervention,
                 M = gform_M,
                 estimand = "factor(regime) + 0"),
    deployment = "worker",
    resources = resources_gform),
...
#                 intervention_pattern = main_wide_pcs$intervention,
#                 M = gform_M,
#                 estimand = "factor(regime) + 0"),
#    deployment = "worker",
#    resources = resources_gform),
...
#                 intervention_pattern = sensitivity_1_pcs$intervention,
#                 M = gform_M,
#                 estimand = "factor(regime) + 0"),
#    deployment = "worker",
#    resources = resources_gform),
...
#                 intervention_pattern = sensitivity_2_pcs$intervention,
#                 M = gform_M,
#                 estimand = "factor(regime) + 0"),
#    deployment = "worker",
#    resources = resources_gform),
