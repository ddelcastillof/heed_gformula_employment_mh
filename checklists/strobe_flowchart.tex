...
\node[
  ...
  \textsuperscript{a}\,As age was imputed by carrying forward the baseline (wave 1) age value, the missing values represent individuals without information at wave 1.
};
